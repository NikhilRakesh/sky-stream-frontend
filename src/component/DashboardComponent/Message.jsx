      ...
      >
        ...
        <div className="body flex px-10 py-5 gap-7 flex-wrap w-full items-center">
          ...
          <div className="body px-10 py-4 border-black w-full gap-4 flex flex-wrap border-[1px]">
            <div className="flex py-4 h-10 items-center w-full  border-gray gap-2">
          ...
          <div className="bg-blue rounded-xl hover:scale-105 transform  px-4 py-2 flex items-center text-white w-fit h-fit gap-x-2">
          <h1>Sumbit</h1>
