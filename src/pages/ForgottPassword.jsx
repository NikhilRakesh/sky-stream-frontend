    ...
    <div className="overflow-hidden relative min-h-screen background-gradiant flex justify-center items-center ">
      ...
      <div className="body w-96 h-fit justify-center flex flex-col gap-10 items-center ">
       ...
       <div className="w-full flex justify-center">
        ...
        <input className="bg-transparent border w-64 text-white px-4 border-slate-500 rounded-xl py-1" type="text" onChange={(e)=>setemail(e.target.value)} />
       ...
       <button className="px-4  items-center text-white" onClick={()=>setOtpinput(true)}>
         {email ? (<div className="flex gap-2 items-center justify-center"><h1>Back</h1><MdOutlineKeyboardBackspace className="mt-1"/> </div>) :(<div className="flex gap-1 items-center justify-center"><h1>Submit</h1><IoIosArrowRoundForward className="mt-1 text-lg font-bold"/> </div>) }
       </button>
       </div>
        </div>
       ...
       {
            otpinput ? (<div className="text-white">
              <input type="number" className="bg-transparent border rounded-xl px-2 w-32 py-1 " />
            </div>) : null
          }
      </div>
